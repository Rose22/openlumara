...
import openlumara.modules.http
from urllib.parse import urlparse


class WebSearch(openlumara.modules.http.Http):
    """
                ...
                for res in raw_results:
                    ...
                    for f in fields:
                        ...
                        if isinstance(original, str) and original.strip():
                            ...
                            sanitization_result = openlumara.modules.http.ContentSanitizer.sanitize_with_detection(original)
