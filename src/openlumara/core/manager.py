...
class Manager:
    ...
    async def run(self):
        ...
        for channel in core.modules.load(openlumara.channels, core.channel.Channel, filter=enabled_channels, reload=True):
        ...
        if enabled_modules:
            ...
            # load modules
            import openlumara.modules
            for module in core.modules.load(openlumara.modules, core.module.Module, filter=enabled_modules, reload=True):
                try:
        ...
        if enabled_user_modules:
            ...
            for module in core.modules.load(openlumara.user_modules, core.module.Module, filter=enabled_user_modules, reload=True):
                try:
